...
order_item_api = Blueprint('order_item_api', __name__)

@order_item_api.route('/order_items', methods=['POST'])
...
@order_item_api.route('/order_items', methods=['GET'])
def get_order_items():
    """
...
@order_item_api.route('/order_items/<string:order_item_id>', methods=['GET'])
...
@order_item_api.route('/order_items/<string:order_item_id>', methods=['PUT'])
...
@order_item_api.route('/order_items/<string:order_item_id>', methods=['DELETE'])
