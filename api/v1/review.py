...
@review_api.route('/reviews/<string:review_id>', methods=['GET'])
...
@review_api.route('/reviews/<string:review_id>', methods=['PUT'])
...
@review_api.route('/reviews/<string:review_id>', methods=['DELETE'])
