...
@vendor_view.route('/vendors', methods=['POST'])
def create_vendor():
    """
    Create a new vendor.
...
@vendor_view.route('/vendors', methods=['GET'])
def get_vendors():
    """
...
@vendor_view.route('/vendors/<string:vendor_id>', methods=['PUT'])
...
@vendor_view.route('/vendors/<string:vendor_id>', methods=['DELETE'])
