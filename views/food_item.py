...
@food_item_view.route('/food_items', methods=['POST'])
...
@food_item_view.route('/food_items', methods=['GET'])
def get_food_items():
    """
...
@food_item_view.route('/food_items/<string:food_item_id>', methods=['GET'])
...
@food_item_view.route('/food_items/<string:food_item_id>', methods=['PUT'])
...
@food_item_view.route('/food_items/<string:food_item_id>', methods=['DELETE'])
